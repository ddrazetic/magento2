...
define([
        ...
        $("#category-widget").on("click", ".mp-blog-expand-tree-2", function () {
        ...
        $("#category-widget").on("click", ".mp-blog-narrow-tree-2", function () {
        ...
        $("#category-widget").on("click", ".mp-blog-expand-tree-3", function () {
        ...
        $("#category-widget").on("click", ".mp-blog-narrow-tree-3", function () {
